...
/* harmony import */ var jquery_maskedinput_src_jquery_maskedinput_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery.maskedinput/src/jquery.maskedinput.js */ "./node_modules/jquery.maskedinput/src/jquery.maskedinput.js");
/* harmony import */ var jquery_maskedinput_src_jquery_maskedinput_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery_maskedinput_src_jquery_maskedinput_js__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var lightbox2_dist_js_lightbox_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lightbox2/dist/js/lightbox.min.js */ "./node_modules/lightbox2/dist/js/lightbox.min.js");
/* harmony import */ var lightbox2_dist_js_lightbox_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lightbox2_dist_js_lightbox_min_js__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _plugins_Modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./plugins/Modal */ "./themes/eva/assets/src/plugins/Modal.js");
/* harmony import */ var _plugins_ContactForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./plugins/ContactForm */ "./themes/eva/assets/src/plugins/ContactForm.js");
/* harmony import */ var _plugins_Cars__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./plugins/Cars */ "./themes/eva/assets/src/plugins/Cars.js");
/* harmony import */ var _plugins_LoadReviews__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./plugins/LoadReviews */ "./themes/eva/assets/src/plugins/LoadReviews.js");
/* harmony import */ var image_compare_viewer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! image-compare-viewer */ "./node_modules/image-compare-viewer/src/scripts/index.js");
...
document.addEventListener('DOMContentLoaded', function () {
  var mobileToggle = document.querySelector('[data-js-action="toggle-menu"]'),
  ...
  var masonryID = document.getElementById('reviews-masonry'),
    reviewsID = document.getElementById('reviews');
  if (reviewsID) {
    new (masonry_layout__WEBPACK_IMPORTED_MODULE_5___default())(masonryID, {
      itemSelector: '.reviews__item'
    });
    new _plugins_LoadReviews__WEBPACK_IMPORTED_MODULE_9__.LoadReviews('[data-js="load-reviews"]', masonryID);
    var reviewsSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('[data-js="reviews-slider"]', {
      slidesPerView: 1,
    ...
    var prevBtn = reviewsID.querySelector('[data-js-action="prev-slide"]'),
  ...
  if (galleryID) {
    var updateButtonOffset = function updateButtonOffset() {
      setTimeout(function () {
        var images = gallerySlider.wrapperEl.querySelectorAll('.swiper-slide');
        var list = [];
        ...
        _nextBtn.style.top = max + 'px';
        _prevBtn.style.top = max + 'px';
      }, 500);
    };
    var gallerySlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('[data-js="gallery-slider"]', {
      slidesPerView: 2.8,
      centeredSlides: true,
      simulateTouch: false,
    ...
    var _prevBtn = galleryID.querySelector('[data-js-action="prev-slide"]'),
      _nextBtn = galleryID.querySelector('[data-js-action="next-slide"]');
    ...
    var images = galleryID.querySelectorAll('[data-js="image-compare"]');
    images.forEach(function (image) {
      new image_compare_viewer__WEBPACK_IMPORTED_MODULE_10__["default"](image, {
        fluidMode: true,
        controlShadow: true,
        addCircle: false,
        addCircleBlur: true
  ...
  var worksID = document.getElementById('works');
  if (worksID) {
    new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('[data-slider="works"]', {
      slidesPerView: 5,
      loop: true,
      spaceBetween: 0,
      pagination: {},
  ...
  new _plugins_Modal__WEBPACK_IMPORTED_MODULE_6__.Modal('[data-js-action="open-modal"]', 'modal');
  new _plugins_ContactForm__WEBPACK_IMPORTED_MODULE_7__.ContactForm('[data-js-action="send-form"]');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-js="phone"]').mask("+7 (999) 999-99-99");
  var carForms = document.querySelectorAll('[data-form="car"]');
  carForms.forEach(function (form) {
    new _plugins_Cars__WEBPACK_IMPORTED_MODULE_8__.Cars(form, '[data-autocomplete]');
  });
  function nubmerIndex() {
    var numbers = document.querySelectorAll('[data-js="number-index"]');
    if (numbers) {
      var title = document.querySelector('[data-js="number-count"]');
      title.textContent = "".concat(numbers.length, " \u0444\u0430\u043A\u0442\u043E\u0432");
...
/***/ "./themes/eva/assets/src/plugins/Cars.js":
/*!***********************************************!*\
  !*** ./themes/eva/assets/src/plugins/Cars.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  _createClass(Cars, [{
    ...
    value: function setup() {
      ...
      this.inputs.forEach(function (input) {
        return input.addEventListener("input", (0,debounce__WEBPACK_IMPORTED_MODULE_0__.debounce)(_this.handleInput, 500).bind(_this));
      });
      var dropdowns = document.querySelectorAll('[data-dropdown-for]');
      if (dropdowns) {
        dropdowns.forEach(function (dropdown) {
          return dropdown.addEventListener("click", _this.handleDropdown.bind(_this));
        });
      }
    ...
    key: "handleInput",
    value: function () {
      var _handleInput = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var target, value, type, name, form, data, dropdown, created, _this$selectedCar, models, filteredModels, _dropdown, _created;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              target = event.target, value = target.value, type = target.dataset.type, name = target.name, form = target.closest("form");
            ...
            case 4:
              data = _context.sent;
              this.cars = Object.keys(data).map(function (key) {
                return {
                  name: key,
                  models: data[key]
                };
              });
              this.filtered = this.cars.filter(function (car) {
                return car.name.toLowerCase().indexOf(value.toLowerCase()) !== -1;
              });
              if (this.filtered.length > 0) {
                dropdown = form.querySelector("[data-dropdown-for=\"".concat(name, "\"]")), created = this.createBrands(this.filtered, name);
            ...
            case 9:
              _this$selectedCar = this.selectedCar(), models = _this$selectedCar.models;
              if (models) {
                filteredModels = this.filteredModels(models, value);
                if (filteredModels.length > 0) {
                  _dropdown = form.querySelector("[data-dropdown-for=\"".concat(name, "\"]")), _created = this.createModels(filteredModels, name);
                  target.classList.add(this.activeInputClass);
                  _dropdown.innerHTML = _created;
                }
              }
            case 11:
            case "end":
      ...
      var _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return fetch('/api/cars').then(function (res) {
                return res.json();
              }).then(function (data) {
                return data.list;
              })["catch"](function (e) {
    ...
    key: "createBrands",
    value: function createBrands(cars, name) {
      return cars.map(function (car) {
        return "<div class=\"form__dropdown-item\" data-input-name=\"".concat(name, "\" data-car-name=\"").concat(car.name, "\">").concat(car.name, "</div>");
      }).join("");
    }
  }, {
    key: "createModels",
    value: function createModels(models, name) {
      return models.map(function (model) {
        return "<div class=\"form__dropdown-item\" data-input-name=\"".concat(name, "\" data-car-name=\"").concat(model, "\">").concat(model, "</div>");
      }).join("");
    }
  }, {
    key: "handleDropdown",
    value: function handleDropdown(event) {
      ...
      if (target && target.dataset.carName) {
        var carName = target.dataset.carName,
    ...
    key: "selectedCar",
    value: function selectedCar() {
      var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      if (key) {
        this.selected = this.filtered.find(function (car) {
          return car.name === key;
        });
        return;
      }
    ...
    key: "filteredModels",
    value: function filteredModels(models, query) {
    ...
    key: "resetModelField",
    value: function resetModelField(form) {
      var modelInput = form.querySelector("input[name=\"".concat(this.MODEL_FIELD, "\"]")),
        modelDropdown = form.querySelector("[data-dropdown-for=\"".concat(this.MODEL_FIELD, "\"]"));
      modelInput.value = "";
    ...
    key: "handleDocument",
    value: function handleDocument(e) {
      var _this2 = this;
      var target = e.target;
      if (target.tagName.toLowerCase() !== "input" && !target.closest("[data-dropdown-for]")) {
        this.inputs.forEach(function (input) {
          input.classList.remove(_this2.activeInputClass);
        });
      }
    }
  }]);
...
/***/ "./themes/eva/assets/src/plugins/ContactForm.js":
/*!******************************************************!*\
  !*** ./themes/eva/assets/src/plugins/ContactForm.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Modal */ "./themes/eva/assets/src/plugins/Modal.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  _createClass(ContactForm, [{
    ...
    value: function send(e) {
      ...
      fetch('/api/sendData', {
        ...
        _this2.preloader.classList.remove(_this2.preloaderActiveClass);
        if (data.status === "error") {
          var errors = _this2.onValidate(data, formData);
          _this2.handleErrors(errors, formEl);
          return;
        }
        var response = document.querySelector('[data-js="success-text"]');
        formEl.reset();
        response.textContent = data.message;
        var trigger = _this2.createTrigger();
        document.body.append(trigger);
        ym(88139097, 'reachGoal', 'zayavka');
        new _Modal__WEBPACK_IMPORTED_MODULE_0__.Modal('[data-js-action="open-modal"]', 'modal');
        trigger.click();
        trigger.remove();
      })["catch"](function (e) {
        _this2.preloader.classList.remove(_this2.preloaderActiveClass);
    ...
    key: "onValidate",
    value: function onValidate(arrayErrors, form) {
      var errors = [];
      Object.keys(arrayErrors).forEach(function (key) {
        if (form.has(key)) {
          arrayErrors[key].forEach(function (err) {
            errors.push({
              key: key,
              message: err
            });
    ...
    key: "handleErrors",
    value: function handleErrors(errors, formEl) {
      var _this3 = this;
      errors.forEach(function (error) {
        _this3.displayError(formEl, error.key, error.message);
      });
    }
  }, {
    key: "displayError",
    value: function displayError(formEl, key, error) {
      var errEl = formEl.querySelector("[data-error-for=\"".concat(key, "\"]"));
      if (errEl) {
    ...
    key: "resetErrors",
    value: function resetErrors(formData, formEl) {
...
/***/ "./themes/eva/assets/src/plugins/LoadReviews.js":
/*!******************************************************!*\
  !*** ./themes/eva/assets/src/plugins/LoadReviews.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var LoadReviews = /*#__PURE__*/function () {
  function LoadReviews(btnEl, masonry) {
    _classCallCheck(this, LoadReviews);
  ...
  _createClass(LoadReviews, [{
    ...
    key: "getReviews",
    value: function () {
      var _getReviews = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "fetchReviews",
    value: function () {
      var _fetchReviews = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(offset) {
        var limit,
          _args2 = arguments;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
    ...
    key: "createFD",
    value: function createFD(data) {
      var fd = new FormData();
      Object.keys(data).forEach(function (key) {
        return fd.append(key, data[key]);
      });
      return fd;
    }
  }, {
    key: "createReviewHtml",
    value: function createReviewHtml(response) {
      return response.map(this.createHtml).join('');
    }
  }, {
    key: "createHtml",
    value: function createHtml(item) {
      return "<div class=\"reviews__item\" data-index=\"".concat(item.id, "\">\n    <div class=\"reviews__item-content\">\n      <p>").concat(item.rewiew, "</p>\n      <svg class=\"reviews__item-polygon\">\n        <use xlink:href=\"").concat("/themes/ivanovo/assets/spritemap.svg" + '#sprite-polygon', "\"></use>\n      </svg>\n    </div>\n    <div class=\"reviews__item-info\">\n      <div class=\"reviews__item-title\">").concat(item.subject, "</div>\n      <div class=\"reviews__item-name\">").concat(item.name, "</div>\n    </div>\n  </div>");
    }
  }]);
  return LoadReviews;
}();
...
/***/ "./themes/eva/assets/src/plugins/Modal.js":
/*!************************************************!*\
  !*** ./themes/eva/assets/src/plugins/Modal.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Modal = /*#__PURE__*/function () {
  function Modal(trigger, modalId) {
  ...
  _createClass(Modal, [{
    ...
    value: function init() {
      ...
      this.$trigger.forEach(function (trigger) {
        trigger.addEventListener("click", _this.hadleClick.bind(_this));
      });
      this.$close.forEach(function (close) {
        close.addEventListener("click", _this.hadleClose.bind(_this));
      });
      document.addEventListener("keydown", function (event) {
        if (event.key === "Escape" && _this.$modalId.classList.contains("modal_active")) {
          _this.closeModal();
        }
      });
      document.addEventListener('mouseleave', function (event) {
        if (event.clientY <= 0 || event.clientX <= 0 || event.clientX >= window.innerWidth || event.clientY >= window.innerHeight) {
          if (!_this.isOpenModal) {
            var offsetBody = _this.getScrollBarWith() + "px";
            if (_this.openModal('leave')) {
    ...
    value: function hadleClick(event) {
      ...
      var offsetBody = this.getScrollBarWith() + "px";
      this.closeAllModals();
    ...
    value: function closeAllModals() {
      ...
      this.$modals.forEach(function (modal) {
        return modal.classList.remove(_this2.activeModalClass);
      });
    }
  }, {
    key: "setTitle",
    ...
    value: function stopVideo() {
      var videos = this.$modalId.querySelectorAll('[data-js="video"]');
...
class ImageCompare {
  ...
  _events() {
    ...
    this.el.addEventListener("mousedown", (ev) => {
      ...
      (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.disableBodyScroll)(this.el, {reserveScrollBarGap: true});
    ...
    document.body.addEventListener("mouseup", () => {
      ...
      (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.enableBodyScroll)(this.el);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ImageCompare);
...
/***/ "./themes/eva/assets/src/app.scss":
/*!****************************************!*\
  !*** ./themes/eva/assets/src/app.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/app"], () => (__webpack_require__("./themes/eva/assets/src/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/app"], () => (__webpack_require__("./themes/eva/assets/src/app.scss")))
